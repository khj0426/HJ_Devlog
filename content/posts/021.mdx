export const post = {
  slug: "서버 컴포넌트에서 Blur이미지 처리하기",
  title: "서버 컴포넌트에서 Blur이미지 처리하기",
  description: "plaiceholder라이브러리와 삽질기",
  date: "2024-02-01",
...
이 속성은 &lt;mark&gt;layout shifts&lt;/mark&gt;를 방지하기 위해 사용할 수 있습니다. 이미지를 불러오기 전까지 아무 화면에 반응이 없다가 이미지가 갑자기 나타나버리면 사용자 입장에서는 불편할 수 밖에 없습니다.
  ...
  [동영상 보기](https://blog.olivierlarose.com/medias/articles/placeholder-next-image/layoutshift.mov)
...
```
  ...
  [동영상 보기](/images/postImg/이미지.webm)
