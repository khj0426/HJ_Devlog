export const post = {
  slug: "HTMLAttributes를 알아보자",
  title: "HTMLAttributes를 알아보자",
  description: "확장가능한 컴포넌트, 어떻게 만들 수 있을까?",
  date: "2023-08-24",
...
```
이 코드에서 정확한 props의 타입이 뭔지 몰라서,단순히 타입스크립트 오류를 벗어나기 위해서, Object라는 타입으로 props를 정의했지만,, 태그에 &lbrace;...props&rbrace;를 전달하는 패턴을 타입스크립트에서는 어떻게 처리하지?? 라는 궁금증이 있었습니다.
