export const post = {
  slug: "Hydration에러 선언적으로 해결하기",
  title: "Hydration에러 선언적으로 해결하기",
  description: "선언적으로 Hydration해결하기",
  date: "2025-05-25",
  image: "/images/postImg/next13.png",
};

# Hydration에러 선언적으로 해결하기
...
ClientGate 컴포넌트는 실제 외부 스토어를 구독하는 것이 목적이 아니므로, 여기서는 아무것도 하지 않는 빈 함수 () =&gt; () =&gt; &lbrace;&rbrace;를 넘겨줍니다.
