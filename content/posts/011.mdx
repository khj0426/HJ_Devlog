export const post = {
  slug: "명령형 프로그래밍과 선언형 프로그래밍",
  title: "명령형 프로그래밍과 선언형 프로그래밍",
  description: "두 프로그래밍 방법은 뭐가 다를까!",
  date: "2023-06-15",
...
만약 앞서 배열을 받아서, 배열의 요소를 2배씩 늘려서 반환하는 선언형 프로그래밍코드에
...
또 다른 예시를 살펴보자. 요구사항은 털 색이 까만색이 포함되어 있으면서 귀가 접히지 않은 고양이들을 뽑는 것이다. 먼저 명령형 프로그래밍 방식으로 이를 구현하면 다음과 같다.
